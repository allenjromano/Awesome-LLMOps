...
- [Infinity](https://github.com/infiniflow/infinity) ![](https://img.shields.io/github/stars/infiniflow/infinity.svg?style=social) - The AI-native database built for LLM applications, providing incredibly fast vector and full-text search
...
- [Starwhale](https://github.com/star-whale/starwhale) ![](https://img.shields.io/github/stars/star-whale/starwhale.svg?style=social) - An MLOps/LLMOps platform for model building, evaluation, and fine-tuning.
